...
public class TestCallbackGlobalAliasing extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevCallbackGlobalAliasing";
	
	
	public TestCallbackGlobalAliasing() throws CoreException {
		super(projectName);
	}
