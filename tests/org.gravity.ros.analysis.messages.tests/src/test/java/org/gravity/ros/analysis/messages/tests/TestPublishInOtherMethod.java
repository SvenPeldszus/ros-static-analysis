...
public class TestPublishInOtherMethod extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevPublishInOtherMethod";
	
	
	public TestPublishInOtherMethod() throws CoreException {
		super(projectName);
	}
