...
public class TestCallbackInOtherFileInOtherClass extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevCallbackInOtherFileInOtherClass";
	
	
	public TestCallbackInOtherFileInOtherClass() throws CoreException {
		super(projectName);
	}
