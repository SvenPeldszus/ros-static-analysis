...
public class TestCallbackImportAliasing extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevCallbackImportAliasing";
	
	
	public TestCallbackImportAliasing() throws CoreException {
		super(projectName);
	}
