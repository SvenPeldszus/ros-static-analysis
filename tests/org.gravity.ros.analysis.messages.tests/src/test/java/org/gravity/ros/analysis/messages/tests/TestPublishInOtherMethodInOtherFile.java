...
public class TestPublishInOtherMethodInOtherFile extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevPublishInOtherMethodInOtherFile";
	
	
	public TestPublishInOtherMethodInOtherFile() throws CoreException {
		super(projectName);
	}
