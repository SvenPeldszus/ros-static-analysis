...
public class TestCallbackMultipleAliasing extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevCallbackMultipleAliasing";
	
	
	public TestCallbackMultipleAliasing() throws CoreException {
		super(projectName);
	}
