...
public class TestCallbackInOtherFile extends TestAbstarctProjectParse {
	...
	private static String projectName = "PyDevCallbackInOtherFile";
	
	
	public TestCallbackInOtherFile() throws CoreException {
		super(projectName);
	}
