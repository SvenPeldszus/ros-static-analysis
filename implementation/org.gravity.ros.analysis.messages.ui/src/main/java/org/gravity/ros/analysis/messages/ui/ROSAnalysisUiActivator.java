package org.gravity.ros.analysis.messages.ui;
 ...
 */
public class ROSAnalysisUiActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.gravity.ros.analysis.messages.ui"; //$NON-NLS-1$
